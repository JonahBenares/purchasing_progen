...
class Rfq extends CI_Controller {
    ...
    public function export_rfq(){
        ...
        foreach($this->super_model->select_row_where('rfq_head', 'rfq_id', $rfq_id) AS $head){
            ...
            $objPHPExcel->getActiveSheet(0)->getColumnDimension('E')->setWidth(5);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$c.':G'.$c)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('B'.$bh.':C'.$bh)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$bh.':F'.$bh)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('H'.$bh.':I'.$bh)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$c.':G'.$c)->applyFromArray($styleArray);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$d.':G'.$d)->applyFromArray($styleArray);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$e.':G'.$e)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$f.':G'.$f)->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
            $objPHPExcel->getActiveSheet(0)->getStyle('E'.$g.':G'.$g)->applyFromArray($styleArray);
            $objPHPExcel->getActiveSheet(0)->getStyle('G'.$g)->getAlignment()->setHorizontal(alignment::HORIZONTAL_RIGHT);
        }
        $objPHPExcel->getActiveSheet(0)->mergeCells('C1:H1');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C2:H2');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C3:H3');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C4:H4');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C5:H5');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C6:H6');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C7:H7');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C9:D9');
        $objPHPExcel->getActiveSheet(0)->mergeCells('C10:D10');
        $objPHPExcel->getActiveSheet(0)->mergeCells('G9:H9');
        $objPHPExcel->getActiveSheet(0)->mergeCells('G10:H10');
        $objPHPExcel->getActiveSheet(0)->mergeCells('G11:H11');
        $objPHPExcel->getActiveSheet(0)->mergeCells('D13:G13');
        $objPHPExcel->getActiveSheet(0)->mergeCells('H13:I13');
        $objPHPExcel->getActiveSheet(0)->mergeCells('J13:K13');
        $objPHPExcel->getActiveSheet(0)->getStyle('A13:K13')->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet(0)->getStyle('A13:K13')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle("C1")->getFont()->setBold(true)->setName('Arial Black');
        $objPHPExcel->getActiveSheet(0)->getStyle('A13:K13')->applyFromArray($styleArray);
        $objPHPExcel->getActiveSheet(0)->getStyle('C1')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C2')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C3')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C4')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C5')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C6')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C7')->getAlignment()->setHorizontal(alignment::HORIZONTAL_CENTER);
        $objPHPExcel->getActiveSheet(0)->getStyle('C9:D9')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        $objPHPExcel->getActiveSheet(0)->getStyle('C10:D10')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        $objPHPExcel->getActiveSheet(0)->getStyle('G9:H9')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        $objPHPExcel->getActiveSheet(0)->getStyle('G10:H10')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        $objPHPExcel->getActiveSheet(0)->getStyle('G11:H11')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        $objPHPExcel->getActiveSheet(0)->getStyle('J9')->getBorders()->getBottom()->setBorderStyle(border::BORDER_THIN);
        /*$objWriter = PHPExcel_IOFactory::createWriter($objPHPExcel, 'Excel2007');
    ...
    public function serve_multiple(){
        $rfq_id=$this->input->post('rfq_id[]');
        foreach($rfq_id AS $r){
            $data_head = array(
                'served'=>1
