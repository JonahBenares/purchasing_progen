...
class Aoq extends CI_Controller {
    ...
    public function export_aoq_prnt_four(){
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('B9:E'.$objPHPExcel->getActiveSheet()->getHighestRow())->getAlignment()->setWrapText(true); 
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('E1:E'.$objPHPExcel->getActiveSheet()->getHighestRow())->getAlignment()->setWrapText(true); 
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('J1:J'.$objPHPExcel->getActiveSheet()->getHighestRow())->getAlignment()->setWrapText(true); 
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('O1:O'.$objPHPExcel->getActiveSheet()->getHighestRow())->getAlignment()->setWrapText(true); 
        ...
        $objPHPExcel->getActiveSheet(0)->getStyle('T1:T'.$objPHPExcel->getActiveSheet()->getHighestRow())->getAlignment()->setWrapText(true); 
